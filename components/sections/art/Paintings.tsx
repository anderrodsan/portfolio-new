...
const Paintings: React.FC = () => {
  ...
  return (
    <div className='snap-start flex flex-col items-center py-10 gap-5 w-full h-full gradient1 px-20 border-b' id='art'>
      <AnimatedTitle className='title flex-between gap-2'>
        <Palette size={30} strokeWidth={2.5}/>
        <p>Art</p>
      </AnimatedTitle>
      <AnimatedText className='text-center text-sm pb-5 -mx-10'>Showcase of my latest artworks using watercolors and markers.</AnimatedText>
      <Carousel
        opts={{
          align: "start",
        }}
